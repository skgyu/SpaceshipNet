...
class Cifar100Dataset(Dataset):
    ...
    def __init__(self,root,train,aug,normalize_transfer=None ):
        ...
        self.dataroot=  os.path.join(root,'cifar-100-python')
        ...
        if not train:
            ...
            labels+=dic['fine_labels'.encode()]
            coarse_labels+=dic['coarse_labels'.encode()]
        ...
        assert(self.len_imageX==len(self.coarse_labels))
    ...
    def __getitem__(self, idx):
        ...
        imageX_coarse_label =   self.coarse_labels[ idx_imageX ]


        return   {'image':imageX,'label':imageX_label,'pos':idx_imageX,'coarse_label':imageX_coarse_label}
